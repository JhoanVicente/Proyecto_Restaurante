...
module.exports = function(Chart) {
	...
	function interpolate(start, view, model, ease) {
		...
		for (i=0, ilen=keys.length; i<ilen; ++i) {
			...
			// if a value is added to the dto after pivot() has been called, the view
...
module.exports = function(Chart) {
	...
	// Private helper to create a tooltip item dto
	...
	/**
	 * Helper to get the reset dto for the tooltip
	...
	Chart.Tooltip = Chart.Element.extend({
		...
		update: function(changed) {
			...
			// Need to regenerate the dto because its faster than using extend and it is necessary due to the optimization in Chart.Element.transition
			// that does _view = _model if ease === 1. This causes the 2nd tooltip update to set properties in both the view and dto at the same time
...
module.exports = function(Chart) {
	...
	function computeBoundary(source) {
		...
		// the dto (scaleTop, scaleBottom and scaleZero) because some external plugins and
